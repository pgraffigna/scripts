...
URL="https://download.documentfoundation.org/libreoffice/stable/7.1.6/deb/x86_64/LibreOffice_7.1.6_Linux_x86-64_deb.tar.gz"
TAR="LibreOffice_7.1.6_Linux_x86-64_deb.tar"
URL_LANG="https://download.documentfoundation.org/libreoffice/stable/7.1.6/deb/x86_64/LibreOffice_7.1.6_Linux_x86-64_deb_langpack_es.tar.gz"
TAR_LANG="LibreOffice_7.1.6_Linux_x86-64_deb_langpack_es.tar"

trap "rm -rf LibreOffice_7.1.6.?_Linux_x86-64_deb* " EXIT
...
function ctrl_c(){
        ...
        sudo dpkg -i LibreOffice_7.1.6.?_Linux_x86-64_deb/DEBS/*.deb &>/dev/null
        ...
        sudo dpkg -i LibreOffice_7.1.6.?_Linux_x86-64_deb_langpack_es/DEBS/*.deb &>/dev/null
